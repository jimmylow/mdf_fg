$(document).ready(function(){
    ...
    var rowTemp = [
         '<tr class="item-row">',
            ...
            '<td><input name="procoupri[]" value="" class="tInput" id="'+idprocoupri+'" style="border-style: none; border-color: inherit; border-width: 0; width: 60px" readonly="readonly"></td>',
            '<td><input name="procotype[]" value="" class="tInput" id="'+idprocotype+'" style="border-style: none; border-color: inherit; border-width: 0; width: 48px" readonly="readonly"></td>',
            '<td><input name="procodoqty[]" value="" class="tInput" id="'+idprocodoqty+'" style="border-style: none; border-color: inherit; border-width: 0; width: 48px; text-align : right" readonly="readonly"></td>',
