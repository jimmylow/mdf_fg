<?php
   ...
   if ($_POST['Submit'] == "Active") {
	...
	if ($_GET['p'] == "Print"){
        ...
        $backloc = "../cons/m_creditnote.php?sorno=".$pcredit."&menucd=".$var_menucode;
       	echo "<script>";
       	echo 'location.replace("'.$backloc.'")';
        echo "</script>"; 
        ...
        if (mysql_numrows($tmpcust) >0) {
          ...
          $var_cname = $rstcust->name;
	           ...
	           /* if ($var_accupd == 0){
	            ...
	            echo '<td align="center"><a href="m_creditnote.php?p=Print&sno='.$salorno.'&menucd='.$var_menucode.'" title="Print Credit Note"><img src="../images/b_print.png" border="0" width="16" height="16" hspace="2" alt="Duplicate Credit Note" /></a></td>';
