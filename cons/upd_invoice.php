      ...
      if(mysql_numrows($tmp) > 0) {
       while ($row = mysql_fetch_array($tmp)) {
         ...
         $var_invno = $var_ordno;
			   ...
			   $sql = "delete from cinvoicedet2 where invno = '$var_invno'"; 
			   mysql_query($sql) or die ("Cant delete 2 : ".mysql_error());         
         
			   $sql = "delete from cinvoicedet1 where invno = '$var_invno'"; 
...
//echo $sql2; //break;
        ...
        $vartoday = date("Y-m-d H:i:s"); 
 		    ...
 		    mysql_query("update `cinvoicemas` 
                     set `less_amt` = '$var_lessamt',
                     modified_by = '$var_loginid',
                     modified_on = '$vartoday',
                     gst = '$vmgst'
                     where `invno` = '$var_ordno'", $db_link) 
                     or die("Cant Update Inv Master ".mysql_error());          
	 ...
	 <legend class="title">UPDATE INVOICE</legend>
	  ...
	  <form name="InpPO" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 993px; ">
		   ...
		   <input class="textnoentry" name="invoicedte" id ="invoicedte" type="text" style="width: 128px;" value="<?php echo $invoicedte; ?>" readonly>
		   </td>
	  	  </tr>  
	  	  <tr>
	  	   <td style="width: 13px"></td>
		  ...
		  <tr>
	  	   ...
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 201px">
			<input class="textnoentry" name="samthyr" id="samthyrid" type="text" maxlength="45" style="width: 100px;" value="<?php echo $mthyr; ?>"></td>		   
		   <td style="width: 10px"></td>
        ...
        echo '>2 | SECOND HALF MONTH</option>';        
		  ...
		  <tr>
	  	   ...
	  	   <td style="width: 13px">:</td>
	  	   <td colspan="5">
		   	<input class="textnoentry" name="custcd" id="sordnoid0" type="text" readonly style="width: 100px;" value = "<?php echo $custcd; ?>">
		   	<input class="textnoentry" name="cname" id="sordnoid0" type="text" readonly style="width: 473px;" value = "<?php echo $var_counter; ?>"></td>
	  	  </tr>       
		  <tr>
	  	   <td style="width: 13px"></td>
		   ...
		   <td>&nbsp;</td>
		   <td style="width: 284px">
       <input type=submit name = "Submit" value="Reissue" class="butsub" style="width: 90px; height: 32px" >       
       </td>
	  	  </tr>	  	  
	  	  </table>
         <br />
