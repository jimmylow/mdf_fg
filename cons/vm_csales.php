<?php
    ...
    if (isset($_POST['Submit'])){ 
     if ($_POST['Submit'] == "Print") {
        ...
        $fname = "csales_mas.rptdesign&__title=myReport"; 
        $dest = "http://".$var_prtserver.":8080/birtfg/frameset?__report=".$fname."&ponum=".$pdordno."&menuc=".$var_menucode."&dbsel=".$varrpturldb."&usernm=".$var_loginid;
        $dest .= urlencode(realpath($fname));

        
        //header("Location: $dest" );
        echo "<script language=\"javascript\">window.open('".$dest."','name','height=1000,width=1000,left=200,top=200');</script>";
        $backloc = "../cons/vm_csales.php?sorno=".$pdordno."&menucd=".$var_menucode;
       	echo "<script>";
	...
	if (isset($_POST['Submit'])){ 
     if ($_POST['Submit'] == "Daily_Sales") {
        $pdordno = $_POST['sordno'];
        
        $fname = "daisales_mas.rptdesign&__title=myReport"; 
        $dest = "http://".$var_prtserver.":8080/birtfg/frameset?__report=".$fname."&ponum=".$pdordno."&menuc=".$var_menucode."&dbsel=".$varrpturldb."&usernm=".$var_loginid;
        $dest .= urlencode(realpath($fname));
	  ...
	  <br>	 
		...
		<table style="width: 993px; " border = "0">
		  <tr>
			...
			<input class="textnoentry" name="sordno" id="sordnoid" type="text" readonly="readonly" style="width: 204px;" value = "<?php echo $var_ordno; ?>">         
		   </td>
		   ...
		   &nbsp;</td>
	  	   ...
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 201px">
		   	<select name="sacustcd" id="sacustcd" style="width: 268px" disabled="">
			 <?php
        ...
        echo '>'.$row['custno']." | ".$row['name'].'</option>';
			...
			<td style="width: 284px">
		   <input class="textnoentry" name="saorddte" type="text" style="width: 128px;" value="<?php  echo $orddte; ?>" readonly="readonly">
		   </td>
	  	  </tr>  
		  <tr>
	  	   <td style="width: 13px"></td>
	  	   ...
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 201px">
			<input class="textnoentry" name="samthyr" id="samthyrid" type="text" maxlength="45" style="width: 100px;" value="<?php echo $mthyr; ?>" readonly="readonly"></td>		   
		   <td style="width: 10px"></td>
		   <td style="width: 204px">Period</td>
		   <td>:</td>
		   <td style="width: 284px">
		   	<select name="speriod" id="speriodcd" disabled="">
			 <?php
				echo '<option value="1"';
        ...
        echo '>2 | SECOND HALF MONTH</option>';        
		  ...
		  <tr>
	  	   ...
	  	   <td style="width: 13px">:</td>
	  	   <td style="width: 201px">
		   	<select name="lesstype" id="lesstypecd" disabled="" >
			 <?php
				echo '<option value="1"';
        ...
        echo '>AMT</option>';                
			...
			<input class="textnoentry" name="lessamt" id="lessamtid" type="text" maxlength="45" style="width: 50px;text-align : right" value="<?php echo $lessamt; ?>" readonly="readonly"></td>		   
		     </td>
		   <td style="width: 10px"></td>
		   <td style="width: 204px">&nbsp;</td>
		   <td>&nbsp;</td>
		  ...
		  <br><br>
            ...
            <tbody>
             ...
             <tr class="item-row">
                ...
                <td>
				<input name="prococode[]" tProItem1=1 id="prococode<?php echo $i; ?>" tabindex="0" class="textnoentry" style="width: 161px" onchange ="upperCase(this.id)" value ="<?php echo htmlentities($rowq['sprocd']); ?>"></td>
                <td>
        ...
        <input name="procotype[]" class="tInput" id="procotype<?php echo $i; ?>" style="border-style: none; width: 48px;" value ="<?php echo $rowq['sptype']; ?>" readonly="readonly"></td>                
                <td>
				<input name="opening[]" id="opening<?php echo $i; ?>" style="border-style: none; width: 48px; text-align : right" value ="<?php echo $rowq['openingqty']; ?>" readonly></td>
                <td>
        ...
        <input name="procobalqty[]" class="tInput" id="procobalqty<?php echo $i; ?>" style="border-style: none; width: 48px; text-align : right" value ="<?php echo $rowq['endbal']; ?>" readonly></td>              
          ...
          <td style = "border-top : 1px dotted; border-bottom : 1px dotted;" align="right">
				  <input name="gtot" id="gtot" class="tInput" readonly="readonly" style="border-style: none; border-color: inherit; border-width: 0; width: 55px; text-align : right" value ="<?php echo number_format($var_tot, 2, '.', ','); ?>"></td>
		 ...
		 <table>
		  	<tr>
				...
				<?php
				 ...
				 if ($var_accvie == 0){
     				echo '<input type=submit name = "Submit" value="Daily_Sales" disabled="disabled" class="butsub" style="width: 95px; height: 32px">';
  				 }else{
    				echo '<input type=submit name = "Submit" value="Daily_Sales" class="butsub" style="width: 95px; height: 32px">';
  				 } 
				?>
				</td>
			</tr>
