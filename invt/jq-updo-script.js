$(document).ready(function(){
    ...
    var rowTemp = [
         '<tr class="item-row">',
            ...
            '<td><input name="procofrm[]" id="'+idprocofrm+'" class="autosearch" style="width: 100px" onchange ="upperCase(this.id)"></td>',
            '<td><input name="procofdesc[]" id="'+idprocofdesc+'" readonly="readonly" style="width: 200px;  border:0;" ></td>',
