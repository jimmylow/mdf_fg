    ...
    if ($_POST['Submit'] == "Save") {
		...
		if ($refno <> "") {
			...
			$sysno = '';
     		...
     		$sqlchk.= " where `descrip` = 'INVTOPB' and counter = 'HQ';";
     		...
     		{
     			$sysno = '0';
     					$sysno_sql = "INSERT INTO ctrl_sysno values ('INVTOPB', 'HQ', 1)";
         	...
         	$vartoday = date("Y-m-d H:i:s");
				$sql = "INSERT INTO invtopen values 
						('$open_sysno', '$refno','$prorevdte', '$remark', 
				...
				$updsysno_sql = "UPDATE ctrl_sysno SET noctrl = '$newsysno' WHERE `descrip` = 'INVTOPB' and counter = 'HQ'";
...
<body onload="setup()">
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 930px;" class="style2">
	 <legend class="title">FG OPENING</legend>
	  <br>	 
