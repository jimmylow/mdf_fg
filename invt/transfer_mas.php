...
function checkdate(pid) {
   var entereddate = document.forms["InpJobFMas"]["trfdte"].value; 
	 ...
	 <legend class="title">STOCK TRANSFER</legend>
	  ...
	  <form name="InpJobFMas" method="POST" action="<?php echo $_SERVER['PHP_SELF'].'?menucd='.$var_menucode; ?>" onsubmit="return validateForm()">
		...
		<table style="width: 886px">
		   ...
		   <input class="inputtxt" name="trfdte" id ="trfdte" type="text" style="width: 128px;" value="<?php  echo date("d-m-Y"); ?>" tabindex="0" onblur="return checkdate(this.id);">
		   <img alt="Date Selection" src="../images/cal.gif" onclick="javascript:NewCssCal('trfdte','ddMMyyyy')" style="cursor:pointer">
			</td>
