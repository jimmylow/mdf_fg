...
function checkdate(pid) {
   var entereddate = document.forms["InpPO"][pid].value; 
   ...
   if(myDate > today) {
     if (pid == "sarcvddte") {
       alert("Received Date is greater than today's date");
       return false;
	 ...
	 <legend class="title">UPDATE GOODS RECEIVED ENTRY (Other Supplier)</legend>
		...
		<table style="width: 993px; ">
		  <tr>
		   ...
		   &nbsp;</td>
			...
			<td style="width: 284px">
		   <input class="inputtxt" name="sarcvddte" id ="sarcvddte" type="text" style="width: 128px;" value="<?php  echo $rcvddte; ?>" onblur="return checkdate(this.id);">
	  ...
	  <tr>
		  ...
		  <tr>
			...
			<td style="width: 16px">:</td>
			<td style="width: 284px">
		   <input class="inputtxt" name="sarefdte" id ="sarefdte" type="text" style="width: 128px;" value="<?php  echo $refdte; ?>" onblur="return checkdate(this.id);">
