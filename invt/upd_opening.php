<?php
    ...
    if ($_POST['Submit'] == "Update") {
		...
		if ($refno <> "") {
				...
				$sql = "update invtopen set openingdate = '$prorevdte', refno ='$refno', remark='$remark', ";
				...
				{	
					foreach($_POST['procomat'] as $row=>$matcd ) {
						...
						if ($matcode <> "")
						{
							...
							$sql = "INSERT INTO invtopendet values 
				...
				$backloc = "../invt/m_opening_mas.php?menucd=".$var_menucode;
           		echo "<script>";
           		echo 'location.replace("'.$backloc.'")';
            	echo "</script>"; 		
		}else{
			$backloc = "../stck_tran/m_opening_mas.php?stat=4&menucd=".$var_menucode;
           	echo "<script>";
           	echo 'location.replace("'.$backloc.'")';
            echo "</script>"; 
		}
...
<body onload="setup()">
  ...
  <div class="contentc">
	...
	<fieldset name="Group1" style=" width: 950px;" class="style2">
	 <legend class="title">RAWMAT OPENING UPDATE :<?php echo $rm_opening_id;?></legend>
	  <br>	 
		...
		<table style="width: 886px">
		 ...
		 <table>
		  	<tr>
				...
				<?php
				 $locatr = "m_opening_mas.php?menucd=".$var_menucode;
