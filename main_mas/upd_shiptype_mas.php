<?php
    ...
    if($var_loginid == "") { 
      ...
      $var_shipcd  = $_GET['shipcd'];
	    $var_shipde = $_GET['shipde'];
	    $var_menucode = $_GET['menucd'];
	}
    
     if ($_POST['Submit'] == "Update") {
    
 		    $var_shipcd  = $_POST['shipcdu'];
        $shipdescd = $_POST['shipdeu'];
        $var_menucode  = $_POST['menudcode'];
         if ($var_shipcd <> "") {
        
         $vartoday = date("Y-m-d H:i:s");
         $sql = "Update shiptype_master set shiptype_desc ='$shipdescd',";
         $sql .= " modified_by='$var_loginid',";
         $sql .= " modified_on='$vartoday' WHERE shiptype_code = '$var_shipcd'";
           
         //echo $sql;  
       	 mysql_query($sql); 
         $backloc = "../main_mas/shiptype_mas.php?menucd=".$var_menucode;
 		     echo "<script>";
...
<body OnLoad="document.InpColMas.shipdeu.focus();">
<?php include("../topbarm.php"); ?> 
   
	<div class="contentc">

	<fieldset name="Group1" style="height: 238px; width: 718px;" class="style2">
	 <legend class="title">EDIT SHIP TYPE MASTER</legend>
	  <br>
	  ...
	  <form name="InpColMas" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="height: 134px">
		...
		<table>
	  	  <tr>
	  	    ...
	  	    <?php
	  	       if (isset($var_shipcd)){
	  	       echo '<input readonly="readonly" class="inputtxt" name="shipcdu" id ="clrcdid" type="text" maxlength="5" onchange ="upperCase(this.id)" value="'.$var_shipcd.'" style="width: 48px">';
	  	       }else{
	  	       echo '<input readonly="readonly" class="inputtxt" name="shipcdu" id ="clrcdid" type="text" maxlength="5" onchange ="upperCase(this.id)" style="width: 48px">';
	  	       }
	  	    ?>
			</td>
	  	  </tr>
	  	  <tr>
	  	    ...
	  	    <td>
	  	     <?php
	  	       if (isset($var_shipde)){
	  	       echo '<input class="inputtxt" name="shipdeu" id ="shipdeid" type="text" maxlength="50" style="width: 354px" onchange ="upperCase(this.id)" value="'.$var_shipde.'">';
	  	       }else{
	  	       echo '<input class="inputtxt" name="shipdeu" id ="shipdeid" type="text" maxlength="50" onchange ="upperCase(this.id)" style="width: 354px" >';
	  	       }
	  	    ?>
...
<?php        
            ...
            $sql .= " where shiptype_code = '".$var_shipcd."'";
