	  ...
	  <form name="InpSuppMas" onsubmit="return validateForm()" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" style="height: 134px; width: 970px;">
	   ...
	   <table>
	    <tr>
	      ...
	      <td>:</td>
	  	  <td>
		  <input class="inputtxt" name="countcd" id ="countcdid" readonly="readonly" type="text" style="width: 161px" value="<?php echo $var_countcd; ?>">
		  </td>
		  <td></td>
		  <td class="tdlabel">Name</td>
	  	  <td>:</td>
	  	  <td>
		  <input class="inputtxt" name="name" id ="nameid" readonly="readonly" type="text" style="width: 350px" value="<?php echo $name; ?>">
		  </td>      
      <tr>
	   	 <tr>
	   	  <td></td>
       ...
       ?>
	  	  ...
	  	  <td>:</td>
	  	  <td>
		  <input class="inputtxt" name="b_over" id ="b_overid" type="text" readonly="readonly" style="width: 80px" value="<?php echo $b_over; ?>">
		  %</td>
		  <td></td>
		  <td class="tdlabel"></td>
	  	  <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="b_sort" id ="b_sortid" type="text" readonly="readonly" style="width: 80px" value="<?php echo $b_sort; ?>">
		  %</td>
          <td></td>
          <td></td>
          <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="best_rate" id ="best_rate" type="text" readonly="readonly" style="width: 80px" value="<?php echo $best_rate; ?>">
		  %</td>
          <td></td>
          <td></td>
          <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="offe_rate" id ="offe_rate" type="text" readonly="readonly" style="width: 80px" value="<?php echo $offe_rate; ?>">
		  %</td>
          <td></td>
          <td></td>
          <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="norm_rate" id ="norm_rate" type="text" readonly="readonly" style="width: 80px" value="<?php echo $norm_rate; ?>">
		  %</td>
          <td></td>
          <td></td>
          <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="spc_rate" id ="spc_rate" type="text" readonly="readonly" style="width: 80px" value="<?php echo $spc_rate; ?>">
		  %</td>
          <td></td>
          <td></td>
          <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="amount1" id ="amount1" type="text" readonly="readonly" style="width: 80px" value="<?php echo $amount1; ?>">
		   the rate is : <input class="inputtxt" name="fix_rate" id ="fix_rate" type="text" readonly="readonly" style="width: 80px" value="<?php echo $fix_rate; ?>">
       </td>
          <td></td>
          <td></td>
          <td></td>
        ...
        <!-- <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="diff_amt" id ="diff_amt" type="text" readonly="readonly" style="width: 80px" value="<?php //echo $diff_amt; ?>">
		  </td>
          <td></td>
          <td></td>
          <td></td>
         ...
         <tr>
          ...
          <td>:</td>
          <td>
			<input class="inputtxt" name="rea_diff" id ="rea_diff" type="text" readonly="readonly" style="width: 200px" value="<?php //echo $rea_diff; ?>">
		  </td>
          <td></td>
          <td></td>
          <td></td>
