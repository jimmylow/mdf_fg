<?php
    ...
    if (isset($_POST['Submit'])){ 
     if ($_POST['Submit'] == "Print") {
        ...
        $backloc = "../sales/vm_saleentry.php?sorno=".$pdordno."&menucd=".$var_menucode;
       	echo "<script>";
	  ...
	  <br>	 
        ...
        echo '>'.$row['custno']." | ".$row['name'].'</option>';
          ...
          if(mysql_numrows($result) > 0) {
           ...
           $sql2 = " select shipqty from salesshipdet";
           $sql2 .= " where shipno = '".$var_ordno."'";
           $sql2 .= " and sprocd = '".$rowq['sprocd']."'";
           
           $result = mysql_query($sql2) or die ("Error uom : ".mysql_error());
          
           if(mysql_numrows($result) > 0) {
             $data = mysql_fetch_object($result);
             $var_ship = $data->shipqty;
        ...
        <input name="procouqty[]" value="<?php echo $var_uqty; ?>" id="procouqty1" style="width: 48px; text-align : right" readonly></td>                
                ...
                <td>
        <input name="procoordpcs[]" id="procoordpcs1" style="width: 48px; text-align : right" value ="<?php echo $var_totpcs; ?>" readonly></td>                
                <td>
        <input name="procoship[]" id="procoship1" style="width: 48px; text-align : right; background-color : red;" value ="<?php echo $var_ship; ?>" readonly></td>                
                <td>
        <input name="procobal[]" id="procobal1" style="width: 48px; text-align : right; background-color : red;" value ="<?php echo $var_bal; ?>" readonly></td>                
             </tr>
